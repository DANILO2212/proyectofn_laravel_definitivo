...
<form action="{{route('actualizar_act', $actor)}}" method="POST" enctype="multipart/form-data" class="form-control form-agregar">
    @csrf
    @method('PUT')
    @if ($errors->any())
        ...
        @endif
    <center><h2>EDITAR ACTOR</h2></center>
    ...
    <label class="form-label">
        fecha de nacimiento:
        <input class="form-control" name="nacimiento" type="date" value="{{ old('nacimiento', $actor->nacimiento) }}">
    </label>
    <br><br>
    <div class="mb-3">
